...
@javax.annotation.Generated(value = "io.swagger.codegen.languages.CseSpringCodegen", date = "2017-11-17T19:37:38.380Z")

@RestSchema(schemaId = "samples")
@RequestMapping(path = "/liyongjun003", produces = MediaType.APPLICATION_JSON)
public class SamplesImpl {
    ...
    public Integer add( @RequestParam(value = "a", required = true) Integer a, @RequestParam(value = "b", required = true) Integer b){
        ...
        return userSamplesDelegate.add(a, b);
    }
    ...
    public String sayHei( @RequestHeader(value="name", required=true) String name){
        ...
        return userSamplesDelegate.sayHei(name);
    }
    ...
    public String sayHello( @PathVariable("name") String name){
        ...
        return userSamplesDelegate.sayHello(name);
    }
    ...
    public String sayHi( @RequestParam(value = "name", required = true) String name){
        ...
        return userSamplesDelegate.sayHi(name);
    }
    ...
    public String saySomething( @RequestParam(value = "prefix", required = true) String prefix, @RequestBody Person user){
        ...
        return userSamplesDelegate.saySomething(prefix, user);
    }
